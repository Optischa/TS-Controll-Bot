...
public class ChannelAPI extends WebApiModule {
    ...
    public void handleApiRequest(HttpExchange httpExchange, String url) {
        ...
        if (method.equalsIgnoreCase("get")) {
            sendResponse(httpExchange, channelManager.getChannels());
            ...
            sendResponse(httpExchange, channelManager.deleteChannel(body.getChannelid()));
        }
    }
}
